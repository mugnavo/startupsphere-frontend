...
import { Startup, User } from "~/lib/schemas";
...
export default function StartupDetailsModal({
  ...
  useEffect(() => {
    fetchUsers();
    setStartupName(startup?.companyName ?? undefined);
    ...
    setStartupCategories(startup?.industry ?? "");
  ...
  console.log(startup, "lll");
  return (
    <dialog id="startup_details_modal" className="modal">
      <div className="modal-box max-w-3xl translate-x-[5%]">
        ...
        >
          ...
          <TextInputField
            ...
            defaultValue={startup?.website ?? undefined}
            disabled={!editable || loading}
          />
          ...
          <TextInputField
            ...
            defaultValue={startup?.companyDescription ?? undefined}
            disabled={!editable || loading}
            textarea
          />
          ...
          <TextInputField
            ...
            placeholder={startup?.locationName || "NULL"}
            value={startup?.locationName}
          ...
          <TextInputField
            ...
            defaultValue={startup?.contactEmail ?? undefined}
            disabled={!editable || loading}
          />
          <TextInputField
            required
          ...
          <TextInputField
            ...
            type="string"
            placeholder="10"
            defaultValue={startup?.numberOfEmployees.toString() ?? "10"}
            disabled={!editable || loading}
          />
          {/* <TextInputField
            required
          ...
          {/* <TextInputField
            ...
            defaultValue={startup?.fundingRounds ?? "Series A"}
            disabled={!editable || loading}
          /> */}
